...
def main():
    ...
    with open(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'output', 'gtsp', 'road_gtsp_ils_result.json')) as f:
        sol = json.load(f)
    path = sol['path']
    ...
    with open(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'output', 'gtsp', 'road_segments.json')) as f:
    ...
    out = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'output', 'gtsp', 'route_roadnet.png')
