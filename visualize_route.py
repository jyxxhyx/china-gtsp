...
def main():
    df = pd.read_csv(os.path.join(os.path.dirname(__file__), '..', 'data', 'cities.csv'))

    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'output', 'schmidt_ils_result.json')) as f:
        sol = json.load(f)
    path = sol['path']
    ...
    out = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'output', 'route.png')
